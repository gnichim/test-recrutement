...
import com.sfeir.playoffs.petclinic.util.EntityUtils;
...
public abstract class AbstractClinicServiceTests {
    ...
    @Test
    public void shouldFindOwnersByLastNameAndCity() {
        Collection<Owner> owners = this.clinicService.findOwnerByLastNameLikeAndCity("avis", "Windsor");
        assertThat(owners.size()).isEqualTo(1);

        owners = this.clinicService.findOwnerByLastNameLikeAndCity("avis", "Monona");
        assertThat(owners.isEmpty()).isTrue();
    }
